...
| 事件         | 条件                 | 界面效果                                                     | 弹窗显示骰子 | 弹窗显示该卡图片 | 弹窗提示                                                     | 弹窗选项                                                   | 后端→前端                    | 前端→后端               |
| ------------ | -------------------- | ------------------------------------------------------------ | ------------ | ---------------- | ------------------------------------------------------------ | ---------------------------------------------------------- | ---------------------------- | ----------------------- |
| 抛骰子       | /                    | 显示骰子，并显示选项“抛一个”、“抛两个（开通【火车站】有该选项）” | /            | /                | /                                                            | /                                                          | 是否开通【火车站】           | 抛的数量                |
| 【广播站】   | /                    | /                                                            | 是           | 是               | ”你的结果是数字x，你可以重抛一次“                            | “重抛一个”、“重抛两个”（开通【火车站】有该选项）、“不重抛” | 投掷结果、是否开通【火车站】 | 抛的数量（0表示不重抛） |
| 【港口】     | 如果骰子和大于等于10 | /                                                            | 是           | 是               | ”你的结果是x，你可以选择是否对骰子结果+2“                    | “结果+2”、“不+2”                                           | 投掷结果                     | 是否+2                  |
| 【拆迁公司】 | 如果被激活           | 选择一个自己的地标建筑                                       | /            | 是               | “确定拆除【xxx】吗？”                                        | “确定”、“取消”                                             | /                            | 卡id                    |
| 【商业中心】 | 如果被激活           | 选择自己的一张卡，选完后选其他人的一张卡                     | /            | 是               | “确定与玩家xx用【xxx】交换他的【xxx】吗？”                   | ”确定“、”取消“                                             | /                            | 两张卡id                |
| 【搬家公司】 | 如果被激活           | 选择自己的一张卡，选完后选其他人                             | /            | 是               | “确定将【xxxx】给予给玩家xx吗？”                             | ”确定“、”取消“                                             | /                            | 卡id、人id              |
| 【金枪鱼船】 | 如果被激活           | /                                                            | 是           | 是               | “你需要投掷一次骰子来决定该牌收益”                           | “投掷”                                                     | /                            | /                       |
| 购买卡       | /                    | 选择商店的一张卡                                             | /            | 是               | “确定购买【xxx】吗？”                                        | ”确定“、”取消“。                                           | 所有购买卡片的id及状态       | 卡id                    |
| 【科技公司】 | 如果能投资           | /                                                            | /            | 是               | “你现在的投资数为x元，你需要继续投资吗？”                    | “继续投资1元”、“不投资“                                    | 当前投资数                   | 是否投资                |
| 【游乐园】   | 如果两骰子点数相等   | /                                                            | 是           | 是               | “你骰子点数相等，额外获得一个回合，确定继续你的下一个回合？” | ”确定“、”取消“。                                           | 当前骰子点数                 | 是否确定                |
